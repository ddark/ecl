...
extern int main(int argc, char **argv)
{
	...
	TC_LOG_INFO(LOG_FILTER_AUTHSERVER, "      ______   __     __   _________  ");
    TC_LOG_INFO(LOG_FILTER_AUTHSERVER, "     / ____/  / /    / /  / _____  /  ");
    TC_LOG_INFO(LOG_FILTER_AUTHSERVER, "    / /      / /____/ /  / /    / /   ");
    TC_LOG_INFO(LOG_FILTER_AUTHSERVER, "   / /      / _____  /  / /____/ /    ");
    TC_LOG_INFO(LOG_FILTER_AUTHSERVER, "  / /____  / /    / /  / _____  /     ");
    TC_LOG_INFO(LOG_FILTER_AUTHSERVER, " /______/ /_/    /_/  /_/    /_/      ");
