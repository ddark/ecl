            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 5:
                        ...
                        break;
                    default:
                        //TC_LOG_ERROR("Unexpected movement variation (%i) in npc_og_suitAI::SetupMovement call!", variation);
                        return;
                }
            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 18:
                        ...
                        break;
                    default:
                        //TC_LOG_ERROR("Unexpected movement variation (%i) in npc_og_infantryAI::SetupMovement call!", variation);
                        return;
                }
            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 4:
                        ...
                        break;
                    default:
                        //TC_LOG_ERROR("Unexpected movement variation (%i) in npc_og_tankAI::SetupMovement call!", variation);
                        return;
                }
            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        //TC_LOG_ERROR("Unexpected movement variation (%i) in npc_og_i_tankAI::SetupMovement call!", variation);
                        return;
                }
...
class npc_og_mekkatorque : public CreatureScript
{
    public:
        ...
        struct npc_og_mekkatorqueAI : public npc_escortAI
        {
            ...
            void SpecialKill(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 1:
                        ...
                        if (uiCannonsDestroyed > 6)
                            //TC_LOG_ERROR("More than 6 Tankbuster Cannons destroyed!");
                        break;
                    case 2:
            ...
            void SpellHit(Unit* pHitter, const SpellInfo* pSpell) //SpellEntry
            {
