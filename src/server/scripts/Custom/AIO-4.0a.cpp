...
if (player->IsInCombat())
{
	...
	case 4000:
        ...
        LoginDatabase.PQuery("INSERT INTO `hacked` (`charname`) VALUES ('%s'", player->GetName().c_str()); // Report it to the DB.
        break;
		...
		case 1100:
        player->CLOSE_GOSSIP_MENU();
        ChatHandler(player->GetSession()).SendSysMessage(LANG_WSG);
        break;
