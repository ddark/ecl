...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    // Disable Chat
	LANG_DISABLE_CHAT                   = 21019,
	LANG_BAN_CHEATER                    = 91002,
    // Vip Commands
  	LANG_PLAYER_NOT_VIP                 = 91003,
  	LANG_VIP_COMMAND_DISABLED           = 91004,
  	LANG_VIP_ERROR                      = 91005,
	 // Fake players
    LANG_FAKE_DND                       = 12003,

	LANG_SOTA                           = 1999999990,
     LANG_AV                             = 1999999991,
     LANG_ARENA_3                        = 1999999992,
     LANG_ARENA_2                        = 1999999993,
     LANG_ARENA_1                        = 1999999994,
     LANG_RANDOM                         = 1999999995,
     LANG_EOTS                           = 1999999996,
     LANG_AB                             = 1999999997,
     LANG_WSG                            = 1999999998,
     LANG_WG                             = 1999999999,
